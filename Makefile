...
gotcha-multiple-fopen-fread-main: gotcha-multiple-fopen-fread-main.c multiple-fopen-wrapper.c multiple-fread-wrapper.c
	$(CC) $(CFLAGS) -o $@ $^ -L$(GOTCHA_LIB) -lgotcha -I$(GOTCHA_INCLUDE)

gotcha-mpi-main: gotcha-mpi-main.c mpi-wrapper.c
